...
SECRET_KEY = 'django-insecure-dt1p%csx!q)l6anl(fytbc#r(d!$qkhfecnmthwca@z^1c(+&2'
...
ROOT_URLCONF = 'coLearning_website.urls'
...
WSGI_APPLICATION = 'coLearning_website.wsgi.application'
